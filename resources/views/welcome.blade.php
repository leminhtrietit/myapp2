...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta charset="utf-8">
        ...
        <link rel="icon" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/images/logo.png') }}" type="image/x-icon" />
        
        <link rel="stylesheet" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/css/animate.css') }}">
        <link rel="stylesheet" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/css/owl.carousel.min.css') }}">
        <link rel="stylesheet" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/css/owl.theme.default.min.css') }}">
        <link rel="stylesheet" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/css/magnific-popup.css') }}">
        <link rel="stylesheet" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/css/flaticon.css') }}">

        <link rel="stylesheet" href="{{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/css/style_detail.css') }}">
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <!-- Begin Page Content -->
                <div class="hero-wrap js-fullheight" style="background-image: url({{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/images/bg_1.jpg') }});" data-stellar-background-ratio="0.5">
    ...
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery-migrate-3.0.1.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery.easing.1.3.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery.waypoints.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery.stellar.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/owl.carousel.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/jquery.animateNumber.min.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/scrollax.min.js') }}"></script>    
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/google-map.js') }}"></script>
    <script src="    {{ asset((env('APP_ENV') == 'local' ? '' : 'public/') . 'assets/js/main.js') }}"></script>
